...
class MediumLevelActionManager(object):
    ...
    def save_to_file(self, filename):
        # Write atomically so interrupted or concurrent planner creation does not
        # leave behind a truncated pickle file.
...
class MediumLevelPlanner(object):
    ...
    def from_pickle_or_compute(mdp, mlp_params, custom_filename=None, force_compute=False):
        ...
        except (FileNotFoundError, ModuleNotFoundError, EOFError, pickle.UnpicklingError) as e:
