    ...
    def get_env_fn(rank):
        def init_env():
            if env_name == "smac":
                ...
                env = LAGEnv(env_args)
            elif env_name == "overcooked_pantheon":
                from harl.envs.overcooked_pantheon.overcooked_env import (
                    OvercookedPantheonEnv,
                )

                env = OvercookedPantheonEnv(env_args)
            else:
...
def make_render_env(env_name, seed, env_args):
    ...
    if env_name == "smac":
        ...
        from harl.envs.overcooked_pantheon.overcooked_env import OvercookedPantheonEnv
