...
SB3_ON_POLICY_TYPES = ['PPO', 'A2C']
SB3_OFF_POLICY_TYPES = ['DQN', 'SAC']
EGO_LIST = SB3_ON_POLICY_TYPES + SB3_OFF_POLICY_TYPES + \
    ['ModularAlgorithm', 'LOAD'] + ADAP_TYPES
PARTNER_LIST = SB3_ON_POLICY_TYPES + SB3_OFF_POLICY_TYPES + \
    ['DEFAULT', 'FIXED'] + ADAP_TYPES
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        description='''\
            ...
            Supported ego-agent algorithms include PPO, A2C, DQN, SAC,
            ModularAlgorithm, ADAP, and ADAP_MULT. The default parameters of
            these algorithms can be overriden using --ego-config.
            ...
            Supported alt-agent algorithms include PPO, A2C, DQN, SAC, ADAP,
            ADAP_MULT, DEFAULT, and FIXED. DEFAULT refers to the default
            hand-made policy in the environment (if it exists). FIXED refers
            to a policy that has already been saved to a file, and will not
            learn anymore.
